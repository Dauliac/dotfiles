...
local nixos_options_expr =
    'let flake = builtins.getFlake ("git+file://" + toString ./.); in flake.nixosConfigurations.' ..
    hostname .. '.options'
local home_manager_options_expr = "(builtins.getFlake (builtins.toString ./.)).homeConfigurations." ..
    hostname .. ".options"
local flake_parts_options_expr =
'(builtins.getFlake ("git+file://" + toString ./.)).debug.options'
local flake_parts_per_system_options_expr =
'(builtins.getFlake ("git+file://" + toString ./.)).currentSystem.options'
    ...
    nixd = {
      ...
      options = {
        ...
        flake_parts_per_system = {
          expr = flake_parts_per_system_options_expr,
        },
      },
    },
  },
