  ...
  return {
    {
      ...
      cmd = function() require("telescope").extensions.ghq.list() end,
      keys = { "n", "<leader>fp" },
      cat = cat,
    },
    {
...
local function fzf_keymaps()
  ...
  return {
    ...
    {
      desc = "Find files",
      cmd = function() require("fzf-lua").files() end,
      keys = { "n", "<leader>ff" },
      cat = cat,
    },
    {
      desc = "Find inside files",
      cmd = function() require("fzf-lua").live_grep_glob() end,
      keys = { "n", "<leader>fg" },
      cat = cat,
    },
    {
      desc = "Find buffers",
      cmd = function() require("fzf-lua").buffers() end,
      keys = { "n", "<leader>fb" },
      cat = cat,
    },
    {
    ...
    {
      desc = "Find tabs",
      cmd = function() require("fzf-lua").tabs() end,
      keys = { "n", "<leader>ft" },
      cat = cat,
    },
  }
...
local function spectre_keymaps()
  ...
  return {
    ...
    },
    {
      ...
      cmd = function() require("spectre").open_visual({ select_word = true }) end,
      keys = { "n", "<leader>sw" },
      cat = cat,
    },
    {
      desc = "Search current word (visual)",
      cmd = function() require("spectre").open_visual() end,
      keys = { "v", "<leader>sw" },
      cat = cat,
    },
    {
      desc = "Search on current file",
      cmd = function() require("spectre").open_file_search({ select_word = true }) end,
      keys = { "n", "<leader>sp" },
      cat = cat,
    },
  }
...
local function todo_keymaps()
  ...
  return {
    ...
    },
    {
      ...
      cmd = function() require("todo-comments").jump_next({ keywords = { "ERROR", "WARNING" } }) end,
      keys = { "n", "]t" },
      cat = cat,
    },
  }
